...
<guide-section
  ...
  <section>
    ...
    <ul>
      ...
      <li>Dashboard: <router-link to="/page-dapp-sections">Example</router-link>, <a href="https://github.com/positivecrash/robonomics-ui-vue3-components-guide/blob/main/src/views/PageDappSections.vue" target="_blank">Source</a></li>
